...
@property (strong, nonatomic) SLPullAnimationHeader *headerView;     // 上面蓝色的 view，可以自定义
...
// 蓝色的 headerView
- (SLPullAnimationHeader *)headerView {
    if (_headerView == nil) {
        _headerView = [[SLPullAnimationHeader alloc] init];
    }
    return _headerView;
}
